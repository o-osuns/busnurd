                    ...
                    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="bg-blue-50 border border-blue-200 rounded-md p-4">
                                    <div class="flex">
                                        ...
                                        <div class="ml-3">
                                            <h3 class="text-sm font-medium text-blue-800">Tips for creating a product</h3>
                                            <div class="mt-2 text-sm text-blue-700">
                                                <ul class="list-disc pl-5 space-y-1">
                                                    <li>Use a clear, descriptive product name</li>
                                                    <li>Create a SEO-friendly slug (lowercase, hyphens for spaces)</li>
                        ...
                        <div class="border-t pt-6">
                            <div class="flex justify-end space-x-3">
                                ...
                                <button type="submit" 
                                        class="bg-blue-500 hover:bg-blue-600 text-gray font-medium py-2 px-6 rounded-md transition-colors duration-200">
                                    Create Product
                                </button>
                            </div>
                        </div>
